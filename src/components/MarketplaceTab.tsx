...
export default function MarketplaceTab({ searchQuery, onSelectProduct }: MarketplaceTabProps) {
  ...
  const [modalProduct, setModalProduct] = useState<MarketplaceProduct | null>(null);
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '14px', alignItems: 'center', marginBottom: '16px' }}>
              <div
                style={{
                  ...
                  height: '56px',
                  borderRadius: '16px',
                  backgroundColor: modalProduct.iconBgColor || '#FFFFFF',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
              ...
              >
                {modalProduct.logoUrl ? (
                  <img
                    src={modalProduct.logoUrl}
                    alt={modalProduct.brand}
                    style={{
                      maxHeight: '100%',
                      maxWidth: '100%',
                      objectFit: 'contain',
                  ...
                  <span
                    style={{
                      fontWeight: 800,
                      fontSize: '18px',
                      color: modalProduct.iconTextColor || '#FFFFFF',
                    }}
                  >
                    {modalProduct.logoText || modalProduct.brand.substring(0, 2).toUpperCase()}
                  </span>
                )}
              </div>
              <div>
                ...
                <p style={{ fontSize: '12px', color: '#6E6E82', marginTop: '2px' }}>
                  Total Price: <strong style={{ color: '#171725' }}>₹{modalProduct.fullPrice.toLocaleString()}</strong>
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p style={{ fontSize: '16px', fontWeight: 800, color: '#712CDC', marginTop: '2px' }}>
                  ₹{Math.round(modalProduct.fullPrice / selectedTenure).toLocaleString()}
                  ...
                  return (
                    ...
                    >
                      ...
                      <span style={{ fontSize: '10px', fontWeight: 500, marginTop: '2px', color: isSel ? '#712CDC' : '#8A8A9E' }}>
                        ₹{Math.round(modalProduct.fullPrice / tenure).toLocaleString()}/mo
                      </span>
                    </button>
                  );
                })}
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                {modalProduct.specs.map((spec, idx) => (
                  <div
                    key={idx}
                    style={{
                      display: 'flex',
            ...
            <button
              onClick={() => {
                alert(`Order initiated for ${modalProduct.title} on ${selectedTenure} months No-Cost EMI!`);
            ...
            >
              <span>Avail No-Cost EMI at ₹{Math.round(modalProduct.fullPrice / selectedTenure).toLocaleString()}/mo</span>
              <ArrowRight size={18} />
            </button>
          </div>
        </div>
